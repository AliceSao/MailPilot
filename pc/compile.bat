...
if not exist "lib\okio-3.9.0.jar" (
    echo [缺少] okio-3.9.0.jar
    set MISSING=1
)
...
if not exist "lib\mailapi-1.6.7.jar" (
    echo [缺少] mailapi-1.6.7.jar
    set MISSING=1
)
if not exist "lib\imap-1.6.7.jar" (
...
if !MISSING! equ 1 (
    ...
    echo   Okio    : https://mvnrepository.com/artifact/com.squareup.okio/okio/3.9.0
...
javac -encoding UTF-8 -Xlint:-deprecation -cp "lib\*" -d out src\*.java
if !errorlevel! neq 0 (
    echo.
